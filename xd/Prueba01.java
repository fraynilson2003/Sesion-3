...
class Prueba01{
  ...
  static void ejercicio05FTT(){  
    ...
    //Datos de entrada
    int opcion=0;
    String mensaje="Por favor elija el proceso a ejecutar, escriba la letra correspondiente:\nA=Calcular promedio de Fundamentos de Programacion \nB=Bono de profesores de acuerdo al salario minimo y puntos obtenidos \nC=Proceso de seleccion de vacuna \nD=Calcular operaciones matematicas basicas con maximo de 2 constantes \nX=Salir del programa";
    System.out.println(mensaje);
    opcion=teclado.nextInt();
    //Proceso   
    do {
      switch(opcion){  
        case 1: ejercicio01FTT();break;
        case 2: ejercicio02FTT();break;
        case 3: ejercicio03FTT();break;
        case 4: ejercicio04FTT();break;
        
        default: System.out.println("Error en el ingreso de datos!!!\nPor favor vuelva a intentarlo");break;
      }
      System.out.println("¿Desea salir del programa? "+mensaje);
      opcion=teclado.nextInt();
